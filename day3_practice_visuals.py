"""
Day 3 Nutrition Practices - Practice Adoption Visuals
=======================================================
Same charts and cleaning rules as Day 1's practice_visuals.py, pointed at
the Day_Three.xlsx workbook. All shared logic lives in mel_common.py so every
day stays visually and methodologically identical - only the config below
changes.

Run with:
    python3 day3_practice_visuals.py
"""
