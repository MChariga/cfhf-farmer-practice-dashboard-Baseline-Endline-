"""
Day 4 Livestock Production Practices - Additional Non-Bar Visuals
==================================================================
Quadrant scatter, alluvial transition diagram, and treemap - same charts as
Day 1's additional_visuals.py, pointed at the Day_Four.xlsx workbook via mel_common.

Run with:
    python3 day4_additional_visuals.py
"""
