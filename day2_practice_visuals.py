"""
Day 2 (Pest Management) - Practice Adoption Visuals
====================================================
Same charts and cleaning rules as Day 1's practice_visuals.py, pointed at
the Day 2 workbook. All the shared logic lives in mel_common.py so every
day stays visually and methodologically identical - only the config below
changes.

Run with:
    python3 day2_practice_visuals.py
"""
