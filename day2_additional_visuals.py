"""
Day 2 (Pest Management) - Additional Non-Bar Visuals
=====================================================
Quadrant scatter, alluvial transition diagram, and treemap - same charts as
Day 1's additional_visuals.py, pointed at the Day 2 workbook via mel_common.

Run with:
    python3 day2_additional_visuals.py
"""
...
INPUT_FILE = "Day_Two.xlsx"
OUT_PREFIX = "day2"
TITLE = "Day 2 Pest Management Practices"
