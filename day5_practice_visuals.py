"""
Day 5 Climate Change Adaptation Practices - Practice Adoption Visuals
=======================================================================
Same charts and cleaning rules as Day 1's practice_visuals.py, pointed at
the Day_Five.xlsx workbook. All shared logic lives in mel_common.py so every
day stays visually and methodologically identical - only the config below
changes.

Run with:
    python3 day5_practice_visuals.py
"""
