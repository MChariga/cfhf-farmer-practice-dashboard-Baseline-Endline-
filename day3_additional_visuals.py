"""
Day 3 Nutrition Practices - Additional Non-Bar Visuals
=======================================================
Quadrant scatter, alluvial transition diagram, and treemap - same charts as
Day 1's additional_visuals.py, pointed at the Day_Three.xlsx workbook via mel_common.

Run with:
    python3 day3_additional_visuals.py
"""
...
INPUT_FILE = "Day_Three.xlsx"
OUT_PREFIX = "day3"
TITLE = "Day 3 Nutrition Practices"
